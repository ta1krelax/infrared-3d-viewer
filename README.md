...
无需 Python 的 v1.8 分享版本位于 `release/Infrared3DViewer_v1.8.exe`；压缩分享包为
`release/Infrared3DViewer_v1.8_Windows_x64.zip`。如需重新打包，双击 `build_exe.bat`。
...
- 水体顶面、侧壁、底面、样品和网格合并为同一个逐面片深度排序场景。100% 不透明的水上样品会正确遮住后方的水体、样品和网格，同时半透明水体仍可显示水下样品。水体各面共用同一材质，轮廓高光也使用相同透明度。
